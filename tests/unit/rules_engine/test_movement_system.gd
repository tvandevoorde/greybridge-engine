...
const MovementSystem = preload("res://rules_engine/core/movement_system.gd")
...
func _fresh_economy(speed_ft: int = 30) -> ActionEconomy:
	var e := ActionEconomy.new(speed_ft)
	e.start_turn()
	return e
