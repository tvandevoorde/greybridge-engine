...
func _test_result_fields() -> void:
	...
	var result := SavingThrow.resolve(14, 2, 2, true, func() -> int: return 10)
...
func _test_basic_failure() -> void:
	...
	var result := SavingThrow.resolve(14, 2, 2, false, func() -> int: return 8)
...
func _test_basic_success() -> void:
	...
	var result := SavingThrow.resolve(14, 3, 2, false, func() -> int: return 15)
...
func _test_exact_dc_is_success() -> void:
	...
	var result := SavingThrow.resolve(14, 2, 2, false, func() -> int: return 12)
...
func _test_proficiency_applied() -> void:
	...
	var result := SavingThrow.resolve(14, 1, 3, true, func() -> int: return 10)
...
func _test_proficiency_not_applied() -> void:
	...
	var result := SavingThrow.resolve(14, 1, 3, false, func() -> int: return 10)
...
func _test_negative_ability_modifier() -> void:
	...
	var result := SavingThrow.resolve(14, -2, 2, false, func() -> int: return 14)
