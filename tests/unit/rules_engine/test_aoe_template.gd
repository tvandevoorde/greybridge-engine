...
func _test_make_radius_keys() -> void:
	...
	var t: Dictionary = AoETemplate.make_radius(Vector2i(3, 4), 20)
	_check(t["type"] == AoETemplate.TYPE_RADIUS,  "type is TYPE_RADIUS")
...
func _test_make_cone_keys() -> void:
	...
	var t: Dictionary = AoETemplate.make_cone(Vector2i(0, 0), Vector2(1, 0), 15)
	_check(t["type"] == AoETemplate.TYPE_CONE,  "type is TYPE_CONE")
...
func _test_make_cone_normalises_direction() -> void:
	...
	var t: Dictionary = AoETemplate.make_cone(Vector2i(0, 0), Vector2(3, 0), 10)
...
func _test_radius_includes_center() -> void:
	...
	var t: Dictionary = AoETemplate.make_radius(Vector2i(5, 3), 10)
	var tiles: Array[Vector2i] = AoETemplate.get_affected_tiles(t)
...
func _test_radius_includes_tiles_within_range() -> void:
	...
	var t: Dictionary = AoETemplate.make_radius(Vector2i(0, 0), 10)
	var tiles: Array[Vector2i] = AoETemplate.get_affected_tiles(t)
...
func _test_radius_1_tile() -> void:
	...
	var t: Dictionary = AoETemplate.make_radius(Vector2i(0, 0), 5)
	var tiles: Array[Vector2i] = AoETemplate.get_affected_tiles(t)
