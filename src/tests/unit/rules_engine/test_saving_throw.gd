...
func _test_result_fields() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, 2, 2, true, func() -> int: return 10)
...
func _test_basic_failure() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, 2, 2, false, func() -> int: return 8)
...
func _test_basic_success() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, 3, 2, false, func() -> int: return 15)
...
func _test_exact_dc_is_success() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, 2, 2, false, func() -> int: return 12)
...
func _test_proficiency_applied() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, 1, 3, true, func() -> int: return 10)
...
func _test_proficiency_not_applied() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, 1, 3, false, func() -> int: return 10)
...
func _test_negative_ability_modifier() -> void:
	...
	var result: SaveResultClass = SavingThrowClass.resolve(14, -2, 2, false, func() -> int: return 14)
...
func _test_half_damage_on_success() -> void:
	...
	_check(SavingThrowClass.apply_damage(20, true, true) == 10, "20 damage, success, half → 10")
	_check(SavingThrowClass.apply_damage(8, true, true) == 4,   "8 damage, success, half → 4")
...
func _test_full_damage_on_failure() -> void:
	...
	_check(SavingThrowClass.apply_damage(20, false, true) == 20,  "20 damage, failure, half_on_success → full 20")
	_check(SavingThrowClass.apply_damage(20, false, false) == 20, "20 damage, failure, no half → full 20")
...
func _test_full_damage_when_no_half_on_success() -> void:
	...
	_check(SavingThrowClass.apply_damage(20, true, false) == 20, "20 damage, success, no half → full 20")
...
func _test_apply_damage_odd_rounds_down() -> void:
	...
	_check(SavingThrowClass.apply_damage(7, true, true) == 3,  "7 damage halved rounds down to 3")
	_check(SavingThrowClass.apply_damage(1, true, true) == 0,  "1 damage halved rounds down to 0")
	_check(SavingThrowClass.apply_damage(15, true, true) == 7, "15 damage halved rounds down to 7")
