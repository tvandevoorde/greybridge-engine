...
const AoEResolverClass  = preload("res://rules_engine/core/aoe_resolver.gd")
...
func _test_actor_outside_area_excluded() -> void:
	...
	var template: Dictionary = AoETemplateClass.make_radius(Vector2i(0, 0), 10)
	...
	var resolver := AoEResolverClass.new()
...
func _test_successful_save_half_damage() -> void:
	...
	var template: Dictionary = AoETemplateClass.make_radius(Vector2i(0, 0), 10)
	var effect: Dictionary = SpellEffectClass.make_saving_throw(10, "DEX", 2, 6, 0, "fire", true)
	var actor: Dictionary = {
		"position": Vector2i(1, 0),
		"ability_modifier": 0,
		"proficiency_bonus": 2,
...
func _test_cone_template_filters_actors() -> void:
	...
	var template: Dictionary = AoETemplateClass.make_cone(Vector2i(0, 0), Vector2(1, 0), 15)
	var effect: Dictionary = SpellEffectClass.make_saving_throw(14, "DEX", 2, 6, 0, "fire", true)
