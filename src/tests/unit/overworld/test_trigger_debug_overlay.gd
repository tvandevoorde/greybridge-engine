## test_trigger_debug_overlay.gd
## Unit tests for TriggerDebugOverlay
## (src/overworld/trigger_debug_overlay.gd).
##
## Run headlessly from the Godot project root (src/) with:
##   godot --headless --script ./tests/unit/overworld/test_trigger_debug_overlay.gd
##
## Exit code 0 = all assertions passed; 1 = one or more assertions failed.
extends SceneTree

const TriggerDebugOverlayClass = preload("res://overworld/trigger_debug_overlay.gd")
...
func _test_debug_invisible_by_default() -> void:
	...
	var overlay := TriggerDebugOverlayClass.new()
