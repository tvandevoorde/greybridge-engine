...
## Manages the dev-only debug state for the trigger tile visualization.
##
## This class holds the trigger-tile data and visibility toggle, and emits
...
class_name TriggerDebugOverlay
extends Node
...
## Set the trigger tile positions and tile size for the overlay.
##
## tiles     : Array of Vector2i — trigger tile grid coordinates.
...
## Returns a copy of the trigger tile positions currently stored.
